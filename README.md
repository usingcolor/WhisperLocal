...
> Early preview (`0.1.5`). Built for daily use on one machine; expect sharp edges.
...
Security reports: see [SECURITY.md](SECURITY.md). Do not file them as public issues.
